...
See https://github.com/kannanr/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/kannanr/goth/examples/main.go to see this in action.
*/
